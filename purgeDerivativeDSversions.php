 ...
 *
 * Example: drush php-script purgeDerivativeDSVersions.php collection_name
 *
 * @author Paul Church
 * @date July 2014
 */
...
if (! $collection) {
    ...
    drush_print("Example: drush scr purgeDerivativeDSVersions.php islandora:collection_name_here");
    return;
}
...
for ($counter = 0; $counter < $totalNumObjects; $counter++) {
    ...
    foreach ($object as $datastream) {
        if (in_array($datastream->label, $derivativeArray)) {
            ...
            $oldestToNewestDSEnd = array_reverse($api_m->getDatastreamHistory($objectPID, $datastream->label));

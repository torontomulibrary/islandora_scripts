...
-->
	...
	<xsl:template match="mods:name">
		<xsl:choose>
			<xsl:when
				test="mods:role/mods:roleTerm[@type='text']='creator' or mods:role/mods:roleTerm[@type='code']='cre' or  mods:role/mods:roleTerm[@type='text']='Author'">
				<dc:creator>
	...
	<xsl:template match="mods:originInfo">
		...
		<xsl:apply-templates select="mods:dateIssued | mods:dateCreated | mods:dateCaptured"/>
	...
	<xsl:template match="mods:typeOfResource">
		...
		<!-- Added 04/09/2014 by MJS to handle migrated values from DigitalCommons -->
		<xsl:if test=". ='thesis' or . ='dissertation' or . ='article' or . ='project' or . ='majorresearch'">
			<dc:type>Text</dc:type>
		</xsl:if>
	</xsl:template>
